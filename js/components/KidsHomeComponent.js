export default {
    ...
    <div class="row">
    <div v-for="media in mediaTypes" :data-type="media.alt" @click="loadMedia(null, media.alt)" class="genre-heading col-2 center kidsIcon"><hr>
        <h1>
          &nbsp &nbsp  <img :src="'images/' + media.icon" :alt="media.name" :width="70">
        </h1>
        <h1>&nbsp {{ media.name }}&nbsp &nbsp</h1><hr>
    </div>
    </div>
                    ...
                    <ul class="media-genres kidsYellow" v-if="activeMediaType == 'video'" >
                        <li>
